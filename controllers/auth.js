...
//telling nodemailer how to deliver email
    ...
    User
      ...
      .then(result => {
        ...
        return transporter.sendMail({
          ...
          html: `
          <p>You requested a change in password</p>
          <p>Click this link <a href="http://localhost:8000/reset/${token}">link</a> to set a new password</p>
          `
        })
      })
      .catch(err => {
